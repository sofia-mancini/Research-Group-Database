...
<head>
  <meta charset="UTF-8">
  <title>Experiments — Research Group DB</title>
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .quick-link-btn.active { border-top: 2px solid #808080; border-left: 2px solid #808080; border-right: 2px solid #fff; border-bottom: 2px solid #fff; background: #b0b0b0; }
...
<body>
  ...
  <div class="ie-window">
    ...
    <div class="address-bar">
      ...
      <input class="address-input" type="text" value="http://localhost/researchdb/experiments.php" readonly>
    ...
    <div class="ie-content">
      ...
      <table class="data-table">
        ...
        <tbody>
          ...
          $experiments = pdo(
              $pdo,
              "SELECT * FROM experiment ORDER BY experiment_id DESC",
          );
          foreach ($experiments as $e):
              $statusClass = match (strtolower($e["status"])) {
          ...
          <tr>
            <td><?php echo htmlspecialchars($e["experiment_id"]); ?></td>
            <td><a href="experiment_view.php?id=<?php echo $e[
                "experiment_id"
            ]; ?>"><?php echo htmlspecialchars($e["title"]); ?></a></td>
  ...
  <div class="taskbar">
    ...
    <div class="taskbar-active">🧪 Experiments — Research Group Database</div>
