...
<head>
  <meta charset="UTF-8">
  <title>Edit Project — Research Group DB</title>
  <style>
...
<body>
  ...
  <div class="ie-window">
    <div class="title-bar">
      <div class="title-bar-text">✏️ Edit Project: Research Group Database — Microsoft Internet Explorer</div>
    ...
    <div class="address-bar">
      ...
      <input class="address-input" type="text" value="http://localhost/researchdb/project_edit.php?id=<?php echo $id; ?>" readonly>
      <button class="go-btn">Go</button>
    </div>

    <div class="ie-content">
      <div class="page-header">
        <h1>✏️ Edit Project #<?php echo $id; ?></h1>
      ...
      <form method="POST" action="project_edit.php?id=<?php echo $id; ?>">
            ...
            <select id="status" name="status">
              <?php foreach (['Active', 'Completed', 'On Hold', 'Cancelled'] as $s): ?>
                <option value="<?php echo $s; ?>"
                  <?php echo $project['status'] === $s ? 'selected' : ''; ?>>
                  <?php echo $s; ?>
                </option>
              <?php endforeach; ?>
            </select>
  ...
  <div class="taskbar">
    ...
    <div class="taskbar-active">✏️ Edit Project — Research Group Database</div>
