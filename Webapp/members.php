...
<head>
<meta charset="UTF-8">
<title>Members — Research Group DB</title>
<style>
...
<div class="ie-window">
  ...
  <div class="address-bar">
    ...
    <input class="address-input" type="text" value="http://localhost/researchdb/members.php" readonly>
  ...
  <div class="ie-content">
    ...
    <table class="data-table">
      ...
      <tbody>
        <?php
        $sql = "SELECT p.*, d.name AS dept_name, d.abbreviation
                FROM Person p
                LEFT JOIN person_dept pd ON p.ID = pd.person_id
        ...
        <tr>
          ...
          <td>
            <?php if (!empty($m["dept_name"])): ?>
              <span title="<?php echo htmlspecialchars($m["dept_name"]); ?>">
                <?php echo htmlspecialchars($m["abbreviation"]); ?>
              </span>
            <?php else: ?>
              —
            <?php endif; ?>
          ...
          <?php if (is_admin($_SESSION['role'])): ?>
          <td>
            <a href="member_edit.php?id=<?php echo $m['ID']; ?>">Edit</a> |
...
<div class="taskbar">
  ...
  <div class="taskbar-active">👥 Members — Research Group Database</div>
