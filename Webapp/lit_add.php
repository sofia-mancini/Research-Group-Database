...
if (!can_add_literature($_SESSION['role'])) {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($title)) {
        ...
        header('Location: literature.php?added=1');
        exit;
    }
}
?>
...
<head>
  <meta charset="UTF-8">
  <title>New Literature: Research Group DB</title>
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .form-row input[type="text"], .form-row input[type="number"], .form-row textarea { flex: 1; background: #fff; border-top: 2px solid #808080; border-left: 2px solid #808080; border-right: 2px solid #fff; border-bottom: 2px solid #fff; padding: 2px 4px; font-family: inherit; font-size: 11px; outline: none; }
...
<body>
  <div class="ie-window">
    <div class="title-bar">
      <div class="title-bar-text">➕ New Literature: Research Group Database — Microsoft Internet Explorer</div>
    ...
    <div class="address-bar">
      ...
      <input class="address-input" type="text" value="http://localhost/researchdb/literature_add.php" readonly>
      <button class="go-btn">Go</button>
    </div>
    <div class="ie-content">
      <div class="page-header">
        <h1>➕ New Literature Entry</h1>
      ...
      <?php endif; ?>
      <form method="POST" action="lit_add.php">
        <div class="form-panel">
          ...
          <div class="form-row">
            ...
            <input type="number" id="year" name="year" min="1900" max="2100" required value="<?php echo htmlspecialchars($_POST['year'] ?? ''); ?>">
          </div>
          <div class="form-row">
            <label for="journal">Journal:</label>
            <input type="text" id="journal" name="journal" value="<?php echo htmlspecialchars($_POST['journal'] ?? ''); ?>">
          </div>
          <div class="form-row">
          ...
          <div class="form-row">
            ...
            <textarea id="theory" name="theory"><?php echo htmlspecialchars($_POST['theory'] ?? ''); ?></textarea>
          </div>
        </div>
        <hr class="divider">
        <div class="btn-row">
  ...
  <div class="taskbar">
    ...
    <div class="taskbar-active">➕ New Literature: Research Group Database</div>
