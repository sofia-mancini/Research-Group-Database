...
<head>
  <meta charset="UTF-8">
  <title>Departments — Research Group DB</title>
  <style>
...
<body>
  <div class="ie-window">
    <div class="title-bar">
      <div class="title-bar-text">🏛️ Departments — Research Group Database — Microsoft Internet Explorer</div>
    ...
    <div class="address-bar">
      ...
      <input class="address-input" type="text" value="http://localhost/researchdb/departments.php" readonly>
    ...
    <div class="ie-content">
      ...
      <div class="quick-links">
        ...
        <a class="quick-link-btn" href="departments.php" style="border-top:2px solid #808080;border-left:2px solid #808080;border-right:2px solid #fff;border-bottom:2px solid #fff;">🏛️ Departments</a>
      </div>
      <hr class="divider">
      <?php if ($_SESSION["role"] === "admin"): ?>
      <button class="toolbar-action" onclick="window.location='department_add.php'">➕ New Department</button>
      <?php endif; ?>
  ...
  <div class="taskbar">
    ...
    <div class="taskbar-active">🏛️ Departments — Research Group Database</div>
