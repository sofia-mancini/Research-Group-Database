...
<head>
  <meta charset="UTF-8">
  <title>Tasks — Research Group DB</title>
  <style>
...
<body>
      ...
      <table class="data-table">
        ...
        <tbody>
          ...
          foreach ($tasks as $t):
              ...
              $progress = intval($t["progress"] ?? 0);
              ?>
          <tr>
            <td><?php echo htmlspecialchars($t["task_id"]); ?></td>
            <td><a href="task_view.php?id=<?php echo $t[
                "task_id"
            ]; ?>"><?php echo htmlspecialchars($t["title"]); ?></a></td>
            <td><span class="status-badge <?php echo $statusClass; ?>"><?php echo htmlspecialchars(
    $t["status"],
); ?></span></td>
            <td>
              <div class="progress-bar-outer" title="<?php echo $progress; ?>%">
  ...
  <div class="taskbar">
    ...
    <div class="taskbar-active">✅ Tasks — Research Group Database</div>
