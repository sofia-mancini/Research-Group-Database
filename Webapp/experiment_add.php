...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($title)) {
        ...
        pdo($pdo,
            "INSERT INTO experiment (title, objective, description, start_date, end_date, status)
             VALUES (:title, :objective, :description, :start_date, :end_date, :status)",
            [
                'title'       => $title,
        ...
        header('Location: experiments.php?added=1');
        exit;
    }
}
?>
...
<head>
  <meta charset="UTF-8">
  <title>New Experiment — Research Group DB</title>
  <style>
...
<?php include 'includes/desktop_icons.php'; ?>
  <div class="ie-window">
    ...
    <div class="address-bar">
      ...
      <input class="address-input" type="text" value="http://localhost/researchdb/experiment_add.php" readonly>
    ...
    <div class="ie-content">
      ...
      <?php endif; ?>
      <form method="POST" action="experiment_add.php">
        <div class="form-panel">
          ...
          <div class="form-row">
            ...
            <textarea id="objective" name="objective"><?php echo htmlspecialchars($_POST['objective'] ?? ''); ?></textarea>
          </div>
          <div class="form-row">
  ...
  <div class="taskbar">
    ...
    <div class="taskbar-active">➕ New Experiment — Research Group Database</div>
