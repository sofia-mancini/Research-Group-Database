-- ============================================================
-- Clean portable dump — works on a new or existing database
-- Usage: mysql -u root research_group_db < research_group_db_clean.sql
-- Or:    mysql -u root -e "CREATE DATABASE research_group_db;"
--        mysql -u root research_group_db < research_group_db_clean.sql
-- ============================================================
...
-- ============================================================
-- DROP TABLES (safe order: junctions first, then parents)
-- ============================================================
...
DROP TABLE IF EXISTS `literature_author`;
...
CREATE TABLE `department` (
  ...
  `abbreviation` varchar(20) COLLATE utf8mb3_unicode_ci NOT NULL,
...
CREATE TABLE `research_group` (
  ...
  `name` varchar(100) COLLATE utf8mb3_unicode_ci NOT NULL,
  `focus` varchar(255) COLLATE utf8mb3_unicode_ci NOT NULL,
...
(1,'Alice Johnson','alice.johnson@uni.edu','Principal Investigator'),
(2,'Bob Martinez','bob.martinez@uni.edu','Principal Investigator'),
(3,'Carol Chen','carol.chen@uni.edu','Lead Data Scientist'),
(4,'David Kim','david.kim@uni.edu','Senior Researcher'),
(5,'Eva Patel','eva.patel@uni.edu','Principal Investigator'),
(6,'Frank Müller','frank.muller@uni.edu','Researcher'),
(7,'Grace Okafor','grace.okafor@uni.edu','Research Associate'),
(8,'Henry Zhao','henry.zhao@uni.edu','Senior Researcher'),
(9,'Isla Rivera','isla.rivera@uni.edu','Postdoctoral Fellow'),
(10,'James Novak','james.novak@uni.edu','Principal Investigator'),
(11,'Laura Schmidt','laura.schmidt@uni.edu','Principal Investigator'),
(12,'Marcus Thompson','marcus.thompson@uni.edu','Senior Researcher'),
(13,'Nadia Volkov','nadia.volkov@uni.edu','Lead Engineer'),
(14,'Omar Hassan','omar.hassan@uni.edu','Principal Investigator'),
(15,'Priya Nair','priya.nair@uni.edu','Principal Investigator'),
(16,'Quinn Fitzgerald','quinn.fitzgerald@uni.edu','Senior Researcher'),
(17,'Rosa Delgado','rosa.delgado@uni.edu','Lead Engineer'),
(18,'Samuel Osei','samuel.osei@uni.edu','Research Associate'),
(19,'Tanya Bergström','tanya.bergstrom@uni.edu','Postdoctoral Fellow'),
(20,'Umar Farooq','umar.farooq@uni.edu','Principal Investigator'),
(21,'Vera Kowalski','vera.kowalski@uni.edu','Senior Researcher'),
(22,'William Tran','william.tran@uni.edu','Postdoctoral Fellow'),
(23,'Xena Papadopoulos','xena.papadopoulos@uni.edu','Lead Engineer'),
(24,'Yusuf Adeyemi','yusuf.adeyemi@uni.edu','Research Associate'),
(25,'Zoe Lindqvist','zoe.lindqvist@uni.edu','Principal Investigator'),
(26,'Aaron Castillo','aaron.castillo@uni.edu','Postdoctoral Fellow'),
(27,'Beatrice Fontaine','beatrice.fontaine@uni.edu','Senior Researcher'),
(28,'Carlos Mendes','carlos.mendes@uni.edu','Principal Investigator'),
(29,'Diana Sato','diana.sato@uni.edu','Research Associate'),
(30,'Elias Andersen','elias.andersen@uni.edu','Lead Engineer');
...
CREATE TABLE `experiment` (
  ...
  `objective` text COLLATE utf8mb3_unicode_ci,
...
CREATE TABLE `literature` (
  ...
  `year` year NOT NULL,
  `journal` varchar(255) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `doi` varchar(255) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `url` varchar(255) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `theory` text COLLATE utf8mb3_unicode_ci,
  PRIMARY KEY (`lit_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
...
(1,1),(9,1),(24,1),(10,2),(30,2),(3,3),(2,4),(8,4),(5,5),(4,6),(19,6),(6,7),(23,7),
(15,9),(7,10),(22,10),(11,11),(21,11),(28,11),(18,12),(14,13),(25,14),(16,15),(20,16),
(17,17),(13,18),(27,18),(12,19),(29,19),(26,20);
...
(1,1),(9,1),(10,2),(30,2),(3,3),(2,4),(8,4),(5,5),(4,6),(19,6),(26,6),(6,7),
(15,9),(7,10),(23,10),(25,10),(11,11),(12,12),(18,12),(14,13),(21,13),(24,14),
(16,15),(20,16),(29,16),(17,17),(22,17),(13,18),(27,18),(28,19);
...
(1,1,'Principal Investigator','2020-01-10'),(2,2,'Principal Investigator','2019-06-01'),
(3,3,'Lead Data Scientist','2021-03-15'),(4,4,'Senior Researcher','2020-09-01'),
(5,5,'Principal Investigator','2021-01-20'),(6,6,'Researcher','2022-02-01'),
(7,7,'Research Associate','2022-05-10'),(8,8,'Senior Researcher','2021-11-01'),
(9,9,'Postdoctoral Fellow','2023-01-05'),(10,10,'Principal Investigator','2020-04-20'),
(11,11,'Principal Investigator','2021-04-01'),(12,12,'Senior Researcher','2020-11-15'),
(13,13,'Lead Engineer','2022-06-01'),(14,14,'Principal Investigator','2021-08-01'),
(15,15,'Principal Investigator','2022-09-01'),(16,16,'Senior Researcher','2020-05-01'),
(17,17,'Lead Engineer','2022-10-01'),(18,18,'Research Associate','2021-03-01'),
(19,19,'Postdoctoral Fellow','2022-07-01'),(20,20,'Principal Investigator','2021-10-01'),
(21,21,'Senior Researcher','2022-01-15'),(22,22,'Postdoctoral Fellow','2021-07-01'),
(23,23,'Lead Engineer','2022-05-15'),(24,24,'Research Associate','2020-06-01'),
(25,25,'Principal Investigator','2021-09-01'),(26,26,'Postdoctoral Fellow','2023-01-01'),
(27,27,'Senior Researcher','2022-02-15'),(28,28,'Principal Investigator','2021-05-01'),
(29,29,'Research Associate','2022-12-01'),(30,30,'Lead Engineer','2021-08-15');
...
(1,1,'Project Lead','2023-01-15'),(2,2,'Project Lead','2022-06-01'),
(3,3,'ML Engineer','2023-03-01'),(4,4,'Climate Modeler','2021-09-01'),
(5,5,'Neuroscientist','2023-07-01'),(6,6,'Biomaterials Engineer','2022-11-01'),
(7,7,'NLP Analyst','2023-05-15'),(8,8,'Optical Engineer','2024-01-01'),
(9,9,'Structural Biologist','2023-02-01'),(10,10,'Computational Chemist','2022-04-01'),
(11,11,'Project Lead','2023-04-01'),(12,12,'Genomic Epidemiologist','2022-01-01'),
(13,13,'Nanofabrication Engineer','2023-06-01'),(14,14,'Observational Astronomer','2022-08-01'),
(15,15,'Cognitive Neuroscientist','2023-09-01'),(16,16,'Marine Chemist','2021-05-01'),
(17,17,'Robotics Engineer','2023-10-01'),(18,18,'Bioinformatician','2022-03-01'),
(19,19,'Atmospheric Scientist','2023-07-01'),(20,20,'Rheologist','2022-10-01'),
(21,21,'Microbiologist','2023-01-01'),(22,22,'Computational Modeler','2022-07-01'),
(23,23,'Microfluidics Engineer','2023-05-01'),(24,24,'Field Ecologist','2021-06-01'),
(25,25,'Geochemist','2022-09-01'),(26,26,'Linguist','2023-11-01'),
(27,27,'Materials Scientist','2023-02-01'),(28,28,'Oncology Researcher','2022-05-01'),
(29,29,'Epidemiologist','2023-03-01'),(30,30,'Synthetic Biologist','2023-08-01');
...
(1,1,'2023-01-20'),(2,2,'2022-06-15'),(3,3,'2023-03-10'),(4,4,'2023-05-01'),
(5,5,'2023-07-10'),(6,6,'2022-12-01'),(7,7,'2023-05-20'),(8,8,'2024-01-15'),
(9,9,'2023-02-10'),(10,10,'2022-04-10'),(11,11,'2023-04-05'),(12,12,'2022-01-10'),
(13,13,'2023-06-10'),(14,14,'2022-08-15'),(15,15,'2023-09-10'),(16,16,'2021-05-10'),
(17,17,'2023-10-10'),(18,18,'2022-03-10'),(19,19,'2023-07-10'),(20,20,'2022-10-10'),
(21,21,'2023-01-10'),(22,22,'2022-07-10'),(23,23,'2023-05-10'),(24,24,'2021-06-15'),
(25,25,'2022-09-10'),(26,26,'2023-11-10'),(27,27,'2023-02-10'),(28,28,'2022-05-10'),
(29,29,'2023-03-10'),(30,30,'2023-08-10');
...
ALTER TABLE `person_dept`
  ADD CONSTRAINT `person_dept_ibfk_1` FOREIGN KEY (`person_id`) REFERENCES `Person` (`ID`),
  ADD CONSTRAINT `person_dept_ibfk_2` FOREIGN KEY (`department_id`) REFERENCES `department` (`department_id`);

ALTER TABLE `person_group`
  ADD CONSTRAINT `person_group_ibfk_1` FOREIGN KEY (`person_id`) REFERENCES `Person` (`ID`),
  ADD CONSTRAINT `person_group_ibfk_2` FOREIGN KEY (`group_id`) REFERENCES `research_group` (`group_id`);

ALTER TABLE `project_member`
  ADD CONSTRAINT `project_member_ibfk_1` FOREIGN KEY (`person_id`) REFERENCES `Person` (`ID`),
...
ALTER TABLE `task_assignment`
  ADD CONSTRAINT `task_assignment_ibfk_1` FOREIGN KEY (`person_id`) REFERENCES `Person` (`ID`),
...
CREATE OR REPLACE VIEW `member_contact_view` AS
SELECT
    p.ID AS person_id,
    p.name,
    p.email,
...
-- ============================================================
-- Done. Verify with:
--   SELECT COUNT(*) FROM Person;       -- expect 30
--   SELECT COUNT(*) FROM experiment;   -- expect 30
--   SELECT COUNT(*) FROM literature;   -- expect 30
--   SELECT COUNT(*) FROM task;         -- expect 30
-- ============================================================